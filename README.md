...
# 회고
경험을 통해 뒤돌아보면 인간의 성공한 모습은 비슷하지만 성공의 방식은 각자 다르다.
나만의 방법을 찾지 않고 다른 사람들의 뒤를 쫓느라 많은 시간을 보내는 게 대부분 사람들이 처한 상황일 것 같다.
그렇기 때문에 샘 알트만은 가능한 젊은 시기에, 여러 시도를 통해 첫 번째 성공을 만들어내는 것이 중요하다고 강조했다.
여러가지 이유로 나는 스스로 늦었다고 생각했다. 하지만 다시 여러가지 상황에 의해, 아직도 나는 나만의 성공경로를 충분히 만들어낼 수 있을만큼 젊다고 생각한다.

샘 알트만의 글은 그 점에서 영감을 준다고 느낀다. 그는 외부의 성공이 아니라 자기 자신의 힘으로 추동하라(internally driven)고 조언한다. 결국 알트만의 글도 하나의 참조점인 거고, 아이펠 역시 내가 지향하는 더 큰 목표의 과정이지 그 자체가 목적이 아니다.

앞으로 서로에게 도움을 줄 수 있는 좋은 친구를 많이 만들고 싶다. 
